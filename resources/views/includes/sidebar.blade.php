      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{{ route('adP.show') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Products</p>
                </a>
              ...
              <li class="nav-item">
                <a href="{{ route('allP.show') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Products</p>
                </a>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{{ route('adU.show') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Unit</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('allU.show') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Units</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            <li class="nav-item">
                <a href="{{ route('adB.show') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Brands</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('allB.show') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Brands</p>
                </a>
              </li>
